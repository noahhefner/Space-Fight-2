...
class Menu(object):
    ...
    def __init__(self):
        ...
        # Make arrays
        self.menu_home_array = sprite_array(self.menu_items_home, SCREEN_WIDTH, \
        SCREEN_HEIGHT, 3, 1)
        self.menu_items_upgrades = sprite_array(self.menu_items_upgrades, \
        SCREEN_WIDTH, SCREEN_HEIGHT, 3, 1)

        # Make scenes
        self.scene_home = Scene(self.menu_home_array)
        self.scene_upgrades = Scene(self.menu_items_upgrades)
